...
const _utils1 = require("../loaders/utils");
...
class TraceEntryPointsPlugin {
    constructor({ rootDir, appDir, pagesDir, compilerType, appDirEnabled, traceIgnores, esmExternals, outputFileTracingRoot, swcLoaderConfig }){
            ...
            await finishModulesSpan.traceAsyncFn(async ()=>{
                ...
                const readFile = async (path)=>{
                    ...
                    try {
                        ...
                        if (!source || (0, _utils1.isClientComponentEntryModule)(mod)) {
