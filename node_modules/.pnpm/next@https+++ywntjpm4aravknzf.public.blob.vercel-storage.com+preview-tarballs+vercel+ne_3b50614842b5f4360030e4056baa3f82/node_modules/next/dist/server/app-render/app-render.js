...
async function renderToHTMLOrFlightImpl(req, res, url, pagePath, query, renderOpts, workStore, parsedRequestHeaders, requestEndedState, postponedState, serverComponentsHmrCache, sharedContext) {
    ...
    if (ComponentMod.__next_app__) {
        ...
        const shouldTrackModuleLoading = ()=>{
            ...
            return !!(workUnitStore && (workUnitStore.type === 'prerender' || workUnitStore.type === 'cache'));
        };
   ...
   */ const params = renderOpts.params ?? {};
    ...
    if (isStaticGeneration) {
        ...
        if (isPossibleActionRequest) {
            ...
            if (actionRequestResult) {
                if (actionRequestResult.type === 'not-found') {
                    ...
                    res.statusCode = 404;
                    const stream = await renderToStreamWithTracing(requestStore, req, res, ctx, notFoundLoaderTree, formState, postponedState);
        ...
        const stream = await renderToStreamWithTracing(requestStore, req, res, ctx, loaderTree, formState, postponedState);
        if (workStore.invalidDynamicUsageError) {
            throw workStore.invalidDynamicUsageError;
        }
        // If we have pending revalidates, wait until they are all resolved.
...
async function renderToStream(requestStore, req, res, ctx, tree, formState, postponedState) {
